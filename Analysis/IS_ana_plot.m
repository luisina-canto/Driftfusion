...
if s.par.mobseti && any(s.par.mu_c) % if there was ion mobility, current due to ions have been calculated, fit it
...
%     if s.par.mobseti && any(s.par.mu_c)
...
%     end
    ...
    figure('Name', ['Single IS, Int ' num2str(s.par.int1) ' Freq '...
        ...
        if s.par.mobseti && any(s.par.mu_c) % if there was ion mobility, current due to ions have been calculated, plot stuff
