...
for i = 1:length(Nani_arr)
    ...
    IS_script_plot_impedance_2(sol_IS_OC(i),i,Nani_arr(i),length(Nani_arr))
    
    % IS_script_plot_nyquist(IS_results)
    IS_script_plot_nyquist_2(sol_IS_OC(i),i,Nani_arr(i),length(Nani_arr))

    % IS_script_plot_phase(IS_results)
    IS_script_plot_phase_2(sol_IS_OC(i),i,Nani_arr(i),length(Nani_arr))
end 
